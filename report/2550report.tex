...
Standard algorithm: colour features, position and neighbours taken into consideration, 1000 threshold cutoff for decision tree & 50\% & 50\%\\\hline
Only colour features taken into consideration & 50\% & 50\%\\\hline
Only colour features and position taken into consideration & 50\% & 50\%\\\hline
Standard algorithm with a greater decision tree cutoff of 2000 & 50\% & 50\%\\\hline
\end{tabular}
...
Possible improvements include considering a neighbourhood wider than a superpixel's immediate neighbours (to help differentiate buildings and sky, faces/flowers and surrounds etc), taking into account a more accurate representation of texture (for example applying applying a gaussian filter to statistically analyse the texture of the superpixel) and inserting more features to differentiate between objects (including their background) of similar colour and contrast.
